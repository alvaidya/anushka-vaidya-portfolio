...
// Removed Typed.js initialization here to allow control from index.html

 document.addEventListener('DOMContentLoaded', function () {
     var typed = new Typed('.typed-words', {
         strings: ["an AI Engineer", "a Software Engineer", "an ML Engineer" ,"a Data Scientist", "a Data Analyst"],
         typeSpeed: 100,
         backSpeed: 50,
         backDelay: 1000,
         startDelay: 500,
    ...
    const ssSwiper = function() {
        ...
        const mySwiper = new Swiper('.swiper-container', {
            ...
            breakpoints: {
                ...
                801: { slidesPerView: 2, spaceBetween: 48 }
            }
         });
